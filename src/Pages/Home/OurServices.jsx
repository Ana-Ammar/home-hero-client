...
const services = [
  {
    ...
    description:
      "Expert home and office cleaning services to keep your space spotless.",
  },
  {
    title: "Plumbing",
    image: "https://images.unsplash.com/photo-1590080878232-71d6f204f0e3",
    description:
      "Reliable plumbing services for leak repairs, pipe installation, and maintenance.",
  },
  {
    title: "Electrical",
  ...
  },
  {
    ...
    description:
      "Quality interior and exterior painting services for homes and offices.",
  },
];
  ...
  return (
    <section className="section-margin">
      ...
      <motion.div
        ...
        className="mt-12 bg-linear-to-br from-primary to-secondary/40 text-white rounded-lg p-8 flex flex-col md:flex-row items-center justify-between"
      >
        ...
        <div>
          <a href="mailto:info@yourbusiness.com" className="btns">
            Contact Us
          </a>
        </div>
      </motion.div>
